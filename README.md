...
<p align="center">
  <img src="./images/industrial_logo.png" alt="Awesome Industrial Vision Datasets" width="800">
</p>

## Welcome 🤗  
A curated collection of **50+ publicly available visual datasets** dedicated to **industrial inspection** 🧑‍🔧.  

This repository serves as a go-to hub for computer vision datasets in industrial applications — from **defect detection** 🩹 and **quality control** ✅ to **manufacturing monitoring** 🏭.  

All datasets are neatly summarized in a **clear, emoji-friendly table** 📊 for quick comparison and easy access 🔍.


<div style="padding: 10px; border-left: 4px solid #f39c12; background-color: #fff8e5; color: #333333;">
...
You can view the dataset information in our Notion page<a href="https://sticky-shape-917.notion.site/1dd7d7150e7e809aba10d92f20598b5e?v=1dd7d7150e7e80648dc9000c498d4ca3&source=copy_link" style="margin-left: 8px;">
  <img src="https://www.clipartmax.com/png/middle/122-1228054_notion-notion-notion-app-icon.png" width="28" alt="Notion Icon" style="border-radius: 6px; vertical-align: middle;" />
</a>.

## Datasets

The following table lists datasets with essential details.  
...
| Dataset Name 🏷️ | #Images 🖼️ | Domain 🏭 | License 📜 | Annotation 📝 | Dataset Link 🔗 | Provider 🏢 | Source 🌍 | Quality ⭐ | Proposed Year 📅 | Citation (BibTeX) 📚 |
|--------------|---------|--------|---------|------------|--------------|----------|--------|---------|---------------|-------------------|
...
| **MULSEN-AD** | 20356 | Mechanics⚙️, Groceries 🛒, Toy 🧸, Medical 🏥, Electronics 💻, Textures 🎨 | MIT | Pixel-level Anomaly, Image-level Anomaly | [Link](https://huggingface.co/datasets/orgjy314159/MulSen_AD/tree/main) | 2035 | Real Objects | High | 2025/06/01 | [mulsenad2025](bibtex/mulsenad2025.md) |
...
| **Real-IAD D**<sup>3</sup>🔥 | 8450 | Mechanics ⚙️, Electronics 💻, Toy 🧸 | N/A | Pixel-level Anomaly, Image-level Anomaly | [Link](https://huggingface.co/datasets/YoutuLab/IAD) | Youtu Lab | Real Objects | High | 2025/04/19 | [realiadd32025](bibtex/realiadd32025.md) |
...
| **OddOneOutAD** | 23000 | Toy 🧸, CAD Model 🖨️| CC BY-NC-SA 4.0 | Image-level Anomaly | [Link](https://github.com/VICO-UoE/OddOneOutAD) | University of Edinburgh | Real Objects | High | 2024/06/28 | [oddoneoutad2024](bibtex/oddoneoutad2025.md) |
...
| **InVar-100**🔥 | 20800 | Mechanics ⚙️, Electronics 💻 | CC-BY 4.0 | N/A | [Link](https://huggingface.co/datasets/ar-100) | Fraunhofer IPK | Real Objects | Mid | 2023/10/06 | [invar2023](bibtex/invar2023.md) |
...
### Column Descriptions
- **Dataset Name** 🏷️: Official name of the dataset.
- **#Images** 🖼️: Approximate number of images or samples, and number of categories if applicable.
...
⚠️ **NOTE:** Individual datasets follow their own licenses.

## Citation
If you want to cite this repository in your paper, you can use the following BibTeX entry:

```bibtex
@misc{awesome-industrial-vision-datasets,
  author = {Shunsuke Sakai},
  title = {Awesome Industrial Vision Datasets},
  year = {2025},
  url = {https://github.com/SkyShunsuke/Awesome-Industrial-Vision-Datasets}
}
```
Thanks!😁
